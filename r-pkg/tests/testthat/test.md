...
<span class="small">Source: <a
href="https://github.com/tidyverse/dplyr/blob/pkgdown-v1.1.4/R/arrange.R"
class="external-link"><code>R/arrange.R</code></a></span>
...
## Usage<a href="#ref-usage" class="anchor" aria-label="anchor"></a>
...
## Arguments<a href="#arguments" class="anchor" aria-label="anchor"></a>

.data<a href="#arg--data" class="anchor" aria-label="anchor"></a>  
...
...<a href="#arg--" class="anchor" aria-label="anchor"></a>  
&lt;<a href="https://rlang.r-lib.org/reference/args_data_masking.html"
class="external-link"><code>data-masking</code></a>&gt; Variables, or
functions of variables. Use [`desc()`](desc.html) to sort a variable in
descending order.

.by\_group<a href="#arg--by-group" class="anchor" aria-label="anchor"></a>  
If `TRUE`, will sort first by grouping variable. Applies to grouped data
frames only.

.locale<a href="#arg--locale" class="anchor" aria-label="anchor"></a>  
...
- If `NULL`, the default, uses the `"C"` locale unless the
  ...
  [dplyr-locale](dplyr-locale.html) help page for more details.

- If a single string from
  <a href="https://rdrr.io/pkg/stringi/man/stri_locale_list.html"
  class="external-link"><code>stringi::stri_locale_list()</code></a> is
  supplied, then this will be used as the locale to sort with. For
  example, `"en"` will sort with the American English locale. This
  requires the stringi package.

- If `"C"` is supplied, then character vectors will always be sorted in
  the C locale. This does not require stringi and is often much faster
  than supplying a locale identifier.
...
[locale](dplyr-locale.html) help page under the `Default locale`
section.

## Value<a href="#value" class="anchor" aria-label="anchor"></a>
...
## Details<a href="#details" class="anchor" aria-label="anchor"></a>

### Missing values<a href="#missing-values" class="anchor" aria-label="anchor"></a>

Unlike base sorting with <a href="https://rdrr.io/r/base/sort.html"
class="external-link"><code>sort()</code></a>, `NA` are:
...
## Methods<a href="#methods" class="anchor" aria-label="anchor"></a>
...
## See also<a href="#see-also" class="anchor" aria-label="anchor"></a>

Other single table verbs: [`filter`](filter.html)`()`,
[`mutate`](mutate.html)`()`, [`reframe`](reframe.html)`()`,
[`rename`](rename.html)`()`, [`select`](select.html)`()`,
[`slice`](slice.html)`()`, [`summarise`](summarise.html)`()`

## Examples<a href="#ref-examples" class="anchor" aria-label="anchor"></a>
